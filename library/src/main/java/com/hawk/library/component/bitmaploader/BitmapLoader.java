package com.hawk.library.component.bitmaploader;
...
import com.hawk.library.component.bitmaploader.core.BitmapCache;
import com.hawk.library.component.bitmaploader.core.BitmapOwner;
import com.hawk.library.component.bitmaploader.core.BitmapProcess;
import com.hawk.library.component.bitmaploader.core.BitmapTask;
...
import com.hawk.library.component.bitmaploader.view.MyDrawable;
...
public class BitmapLoader {
	...
	public BitmapBytesAndFlag doDownload(String imageUrl, final ImageConfig config) throws Exception {
		...
		if (bitmapBytes != null && config.getProgress() != null)
			config.getProgress().sendFinishedDownload();
