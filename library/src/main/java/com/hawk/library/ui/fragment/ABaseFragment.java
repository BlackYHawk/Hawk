package com.hawk.library.ui.fragment;
...
import com.hawk.library.R;
import com.hawk.library.common.utils.Logger;
import com.hawk.library.common.utils.ViewUtils;
import com.hawk.library.component.bitmaploader.BitmapLoader;
import com.hawk.library.component.bitmaploader.core.BitmapOwner;
import com.hawk.library.network.biz.ABizLogic;
import com.hawk.library.network.task.ITaskManager;
import com.hawk.library.network.task.TaskException;
import com.hawk.library.network.task.TaskManager;
import com.hawk.library.network.task.WorkTask;
import com.hawk.library.support.inject.InjectUtility;
...
public abstract class ABaseFragment extends Fragment implements ITaskManager, BitmapOwner {
     ...
     * {@link ABaseFragment#taskStateChanged(ABaseTaskState, Serializable)}
     *
     * @author wangdan
     *
     * @param <Params>
     ...
     * @return
     */
    final protected ABizLogic.CacheMode getTaskCacheMode(@SuppressWarnings("rawtypes") WorkTask task) {
