...
package com.hawk.middleware.http.async;
 ...
 * with additional parameters by passing a {@link com.hawk.middleware.http.async.RequestParams} instance,
 * and responses can be handled by passing an anonymously overridden 
 * {@link com.hawk.middleware.http.async.AsyncHttpResponseHandler} instance.
 * <p>
 * For example:
 * <p>
 * <pre>
...
public class AsyncHttpClient {
     ...
     * @param cookieStore The CookieStore implementation to use, usually an instance of {@link com.hawk.middleware.http.async.PersistentCookieStore}
     */
